        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="{{route('admin_image_store', ['content_id'=>$data->id])}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                        ...
                        @foreach($images as $rs)
                            <tr>
                                ...
                                <td><a href="{{route('admin_image_delete', ['id'=> $rs->id, 'content_id'=>$data->id])}}" onclick="return confirm('Delete! Are you sure?')"><i class="fa fa-trash-o" style="color: #950B02"></i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
