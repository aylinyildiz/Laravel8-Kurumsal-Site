...
@section('content')
    ...
    <section>
            <div class="mb-3" style="width: 10%; margin-left: 8%">
                <a href="{{route('user_content_add')}}" type="button" class="btn btn-success btn-sm"><i
                        class="fa fa-magic"></i>&nbsp; İçerik Ekle</a>
                ...
                <table class="table table-striped" style="border: 1px solid gray">
                    ...
                    @foreach($datalist as $rs)
                        <tr style="overflow: hidden;height: 60px;">
                            ...
                            <td>{{$rs->status}}</td>
                            <td><a href="{{route('user_content_edit', ['id'=> $rs->id])}})}}"><img
                                        src="{{asset('assets')}}/img/edit.png" alt=""></a></td>
                            <td><a href="{{route('user_content_delete', ['id'=> $rs->id])}}"
                                   onclick="return confirm('Delete! Are you sure?')"><img
                                        src="{{asset('assets')}}/img/trash.png" alt=""></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
